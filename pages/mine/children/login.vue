<template>
	<view class="login">
		<view class="content">
			...
			<!-- 主体表单 -->
			<view class="main">
				<wInput v-model="phoneData" type="text" maxlength="11" placeholder="用户名:admin"></wInput>
				<wInput v-model="passData" type="password" maxlength="11" placeholder="密码:admin"></wInput>
			</view>
...
<script>
	...
	export default {
		...
		methods: {
			...
			// 	setTimeout(function() {
			// 				//简单验证下登录（不安全）
			// 				if (_this.phoneData == 'admin' && _this.passData == 'admin') {
			// 					let userdata = {
			// 						"username": 'admin',
			// 						"nickname": 'admin',
