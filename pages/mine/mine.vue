<template>
	<view class="mine animation-fade" style="overflow-x: hidden;">
		<!-- 顶部 -->
		...
		<view class="info" :style="{marginTop: statusBarHeight + 44 + 'px'}">
			...
			<view class="info-content">
				<view class="info-avatar">
					<image class="info-avatar-pic" src="/static/github.png" mode=""></image>
				</view>
				<view class="info-name">
					<text class="info-name">{{login ? uerInfo.nickname : '您未登录'}}</text>
					<text class="info-level">键盘艺术家</text>
				</view>
			</view>
			
			<view class="info-asset">
				<view class="info-asset-item">
					<text class="iai-title">公司</text>
					<text class="iai-value">CMHK</text>
				</view>
				<view class="info-asset-item">
					<text class="iai-title">时长</text>
					<text class="iai-value">4年</text>
				</view>
				<view class="info-asset-item">
					<text class="iai-title">职位</text>
					<text class="iai-value">软件工程师</text>
				</view>
			</view>
		</view>
